...
- Here is my docker-compose file, its in this repo as well
...
services:
  ...
  order-service:
    image: jbelangerac/order-service:latest
  ...
  product-service:
    image: jbelangerac/product-service:latest
  ...
  store-front:
    image: jbelangerac/store-front:latest
